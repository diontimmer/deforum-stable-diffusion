...
prompt_box = sg.Column([
    ...
    [sg.Text('Models Path: '), sg.Input(f'{os.path.dirname(os.path.realpath(sys.argv[0]))}\\models', key='-MODELS_PATH-', size=(80, 1), enable_events=True, readonly=True, disabled_readonly_background_color=sg.theme_input_background_color()), sg.FolderBrowse()],
    [sg.Text('Output Path: '), sg.Input(f'{os.path.dirname(os.path.realpath(sys.argv[0]))}\\outputs', key='-OUTPUT_PATH-', size=(80, 1), readonly=True, disabled_readonly_background_color=sg.theme_input_background_color()), sg.FolderBrowse()],
